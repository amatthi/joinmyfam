...
import FamSubscription from '../misc/FamSubscription'
  ...
  render() {
    return <FamSubscription>
      { ({error, isLoading, subscription}) => {
        ...
        const cancelConfirmation = `Are you sure you want to cancel your subscription? You won't have access to paid Fam features.`
